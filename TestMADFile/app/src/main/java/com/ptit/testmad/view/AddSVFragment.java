...
public class AddSVFragment extends Fragment {
    ...
    public AddSVFragment(FileManager databaseHelper, MainActivity mainActivity) {
    ...
    private void initView() {
        ...
        binding.btnAddSv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int id=0;
                if (databaseHelper.getAllSinhVien()!= null){
                    id=databaseHelper.getAllSinhVien().length;
                }
                SinhVien sinhVien = new SinhVien(id,ten, ns, quequan, nh);
                databaseHelper.addStudent(sinhVien.toString());
